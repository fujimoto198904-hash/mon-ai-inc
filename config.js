...
window.OFFICE_CONFIG = {
  ...
  employees: [
    ...
    { id: 'kato', wage: 1800, name: '加藤', dept: '総務部', role: 'クロード作業(雑務)',
      hair: '#8a5a2e', shirt: '#c8a04a', desk: { x: 290, y: 216 }, tag: '雑務全般',
      source: 'claude', pc: 'laptop' },
    { id: 'shirayanagi', wage: 1500, name: '白柳', dept: '清掃', role: 'クリーンスタッフ',
      hair: '#2a2a2a', shirt: '#b8d8cc', desk: { x: 236, y: 320 }, source: 'janitor' },
    { id: 'zama', wage: 1800, name: '座間', dept: '総務部', role: 'コーデックス作業(その他)',
