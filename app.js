...
function drawOffice(g, t, tm) {
  ...
  drawProp(g, 'coat', 262, 308, 16, 36);
  drawProp(g, 'umbrella', 372, 318, 12, 26);

  // ミーティングスペース(丸テーブル)
  drawProp(g, 'mtable', 409, 198, 32, 30);
